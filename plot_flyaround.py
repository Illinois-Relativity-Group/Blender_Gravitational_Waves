...
#----------------------------flyaround----------------------------#
start_frame = 1
end_frame = 120  # or however long you want your animation

# Set initial camera position
camera_used.location = (600, -475, -160)
camera_used.rotation_euler = (296*np.pi/180, -108.19*np.pi/180, -153.6*np.pi/180)
camera_used.keyframe_insert(data_path="location", frame=start_frame)
camera_used.keyframe_insert(data_path="rotation_euler", frame=start_frame)

# Set final camera position
camera_used.location = (1300, 0, -15)
camera_used.rotation_euler = (-180*np.pi/180, -90*np.pi/180, 360*np.pi/180)
camera_used.keyframe_insert(data_path="location", frame=end_frame)
camera_used.keyframe_insert(data_path="rotation_euler", frame=end_frame)
#----------------------------flyaround----------------------------#
